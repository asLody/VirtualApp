...
7月10日最新商业版更新：<br/>
1、适配autofill服务，例如piexl系列<br/>
2、完善64位的io hook<br/>
目前已知问题：<br/>
1、无法启动部分阿里加固过的app，例如：墨迹天气<br/>
2、网易新闻的微博分享sdk调用不正常<br/>

7月6日最新商业版更新：<br/>
1、优化hook库的兼容性，加回dlopen<br/>
2、64位扩展包的so移到32位主包。（jni代码改动后，在Run之前，请先build一次）<br/>
3、通知栏改动：适配8.1的通知渠道；移除应用时，移除应用的全部通知<br/>
4、兼容部分app，需要设置android:largeHeap=true<br/>
5、修复ffmpeg库的视频无法播放问题<br/>
6、优化横竖屏切换<br/>
7、降低通过Intent.ACTION_VIEW调用外部Activity限制。<br/>
8、兼容MG SDK<br/>
